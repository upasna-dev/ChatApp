...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
          ...
          if (isChat)
          {
              lastMessage(user.getId(), holder.lst_msg);
          }else {
              holder.lst_msg.setVisibility(View.INVISIBLE);
          }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            lst_msg = itemView.findViewById(R.id.last_msg);
        }
    }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                  for (DataSnapshot snapshot : datasnapshot.getChildren())
                  {
                      ...
                      chat.getReceiver().equals(firebaseUser.getUid()) && chat.getSender().equals(firebaseUser.getUid()))
                      {
